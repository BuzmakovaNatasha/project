    ...
    methods: {
        ...
        deleteFromBasket() {
            this.productsInCart.forEach(el => {
                if (el.quantity == 0) {
                    this.productsInCart.splice(this.productsInCart.indexOf(el), 1);
                }
            });
        },
    },
                ...
                <div class="basket-box" v-show="isVisibleCart">
                    ...
                    <div v-else class="product-cart__item" v-for="productInCart of productsInCart" :key="productInCart.id_product">
                        ...
                        <div class="product-quantity">
                            <input type="number" :data-id="productInCart.id_product" v-model="productInCart.quantity" :value="productInCart.quantity" min="0" @change="deleteFromBasket">
                        </div>
